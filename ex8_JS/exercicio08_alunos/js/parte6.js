...
var txtOriginal;
var copiado;
var copiado2 = document.getElementById("c3").value;
...
document.getElementById("escreve").onclick = function () {
    document.getElementById("textop").innerText = texto1;
    document.getElementById("textop").style.fontWeight = "bold";
};
//6.4.
...
document.getElementById("apaga").onmouseover = function () {
    txtOriginal = document.getElementById("apaga").innerText;
...
document.getElementById("c6").onkeyup = function () {
    document.getElementById("c7").innerHTML = 500 - document.getElementById("c6").value.length;
